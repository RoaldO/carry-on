Feature: Profile Display
  ...
  Background:
    Given a user exists with email "profile@example.com" and password "Password5678!" and display name "Test Profile User"
    And I am logged in as "profile@example.com" with password "Password5678!"
